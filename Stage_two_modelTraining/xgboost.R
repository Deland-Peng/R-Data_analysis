xgb_param <- function(best_param,best_loss,best_lost_index,seed.number,watchlist,fold,nthreads){
  ...
  #max_depth. <- c(3:11) : 0.766
  max_depth. <- c(2:6)
  #min_child_weight. <- c(3:18) : 0.766
  ...
  #save("result", file = sprintf("Stage2/all_model/result/all_features/%d_xgb_result.RData", fold))
  #save("result", file = sprintf("Stage2/all_model/result/10_features/%d_xgb_result.RData", fold))
  #save("result", file = sprintf("Stage2/all_model/result/17_features/%d_xgb_result.RData", fold))
  #save("result", file = sprintf("Stage2/all_model/result/half_features/%d_xgb_result.RData", fold))
  #save("result", file = sprintf("Stage2/all_model/result/52_features/%d_xgb_result.RData", fold))
  save("result", file = sprintf("Stage2/all_model/result/48_features/%d_xgb_result.RData", fold))
}
